...
class MeetingPrepTask:
    @staticmethod
    def research_task(agent, participants, meeting_context):
        return Task(
    ...
    @staticmethod
    def meeting_strategy_task(agent, meeting_context, research_objective):
        return Task(
            description=dedent(f"""\
    ...
    @staticmethod
    def summary_and_briefing_task(agent, meeting_context, research_objective):
        return Task(
            description=dedent(f"""\
              ...
              Meeting Context: {meeting_context}
              Strategy Objective: {research_objective}"""),
